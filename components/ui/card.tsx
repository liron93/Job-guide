  ...
  return (
    <div
      ...
      className={cn(
        ...
        "ring-1 ring-black/[0.07] dark:ring-white/[0.07] shadow-sm shadow-black/10 dark:shadow-black/20",
        "transition-all duration-200",
        "hover:ring-black/[0.12] dark:hover:ring-white/[0.12] hover:shadow-md hover:shadow-black/20 dark:hover:shadow-black/30",
